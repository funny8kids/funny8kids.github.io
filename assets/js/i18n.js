...
(() => {
  ...
  const DICT = {
    en: {
      ...
      'work.card.orbit.cat': 'EXPERIENTIAL SITE',
      'work.card.lumen.cat': 'E-COMMERCE',
      'work.card.mood.cat': 'AI PRODUCT',
      'work.card.pulse.cat': 'WEBGL EXPERIENCE',
      'work.card.open': 'OPEN CASE',
      'work.card.more': 'MORE',
      ...
      'lab.copy': "The whole solar system in miniature — the Sun, eight planets, Saturn's rings and an asteroid belt, each on a concentric orbit at its true Kepler speed. Drag to fly the camera, scroll to zoom, hover a planet for its name, click to lock the view onto it. Procedural textures mean zero downloads; it pauses off-screen and renders at 30fps, halving GPU cost.",
      ...
      'footer.social.bilibili': 'BILIBILI',
    ...
    zh: {
      ...
      'work.card.orbit.cat': '体验型网站',
      'work.card.lumen.cat': '电商',
      'work.card.mood.cat': 'AI 产品',
      'work.card.pulse.cat': 'WEBGL 实验',
      'work.card.open': '打开案例',
      'work.card.more': '更多',
      'work.card.cta': '全部项目',
      ...
      'lab.copy': '把整个太阳系收进方寸之间 —— 太阳、八大行星、土星环与小行星带，各沿同心轨道按真实 Kepler 速度公转。拖拽转动镜头，滚轮缩放，悬停行星显示名字，点击锁定跟随；程序化纹理零下载，离屏即暂停、隔帧 30fps 渲染省一半 GPU。',
